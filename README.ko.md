...
| **Turbo** | 28스텝 교사를 4–8스텝 생성기로 Decoupled DMD 증류 (Liu et al., 2025). 출력은 일반 LoRA — `--infer_steps 4 --cfg 1.0`으로 추론. `make exp-turbo`. | [dmd2-decoupled.md](docs/experimental/dmd2-decoupled.md) |
