...
def main():
    ...
    ap.add_argument("--amp", action=argparse.BooleanOptionalAction, default=True,
                    help="mixed-precision autocast on the net + native AMP-dtype VQGAN "
    ...
    snap = {"method": f"resshift_{args.version}", "version": args.version, "config": config,
            ...
            "compile": args.compile, "grad_ckpt": args.grad_ckpt,
            "text_boxes": args.text_boxes, "text_crop_prob": args.text_crop_prob,
            "scale_jitter_prob": args.scale_jitter_prob,
            "scale_jitter_max": jitter_max}
    ckpt_meta = {"amp": args.amp, "amp_dtype": amp_dtype_name}
    ...
    print(f"training: version={args.version} cond_lq={cond_mode} iters={args.iters} "
          f"bs={args.bs}x{args.grad_accum} sf={sf} T={T} amp={args.amp} "
          f"amp_dtype={amp_dtype_name} compile={args.compile} grad_ckpt={args.grad_ckpt} "
