...
class LoRANetwork(_NetworkMetricsMixin, torch.nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        def create_modules(
            ...
            for lora_name, child_module, dim, alpha_val, original_name in tqdm(
                ...
                if (
                    ...
                    and is_unet
                    and effective_module_class not in (LoKRModule, LoHaModule)
                ):
        ...
        # LoKR/LoHa: split fused qkv_proj/kv_proj into per-component q_proj/
        ...
        if getattr(cfg, "use_lokr", False) or getattr(cfg, "use_loha", False):
    ...
    def apply_max_norm_regularization(self, max_norm_value, device):
        ...
        if not norms:
            # LyCORIS-native variants (LoKr/LoHa) carry no lora_down/lora_up
            # keys — nothing to regularize. Report a clean no-op instead of
            # dividing by zero at the first --scale_weight_norms step.
            return 0, 0.0, 0.0
