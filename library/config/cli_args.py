...
def add_training_arguments(parser: argparse.ArgumentParser, support_dreambooth: bool):
    ...
    parser.add_argument(
        ...
        default=False,
        help=(
            "repeat every source image at every target_res tier within each epoch. "
            "Requires VAE caches generated by multi-resolution preprocessing and "
            "at least two target_res values"
        ),
    )
    parser.add_argument(
        "--dynamo_backend",
    ...
    parser.add_argument(
        ...
        type=str,
        default="methods",
        help="subfolder under configs/ that holds the method file (default 'methods'). Use 'gui-methods' for self-contained per-variant configs (lora, ortholora, tlora, reft, hydralora, …).",
    )
    parser.add_argument(
        "--output_config",
        action="store_true",
